...
import SendConfirmationDialogMessage from 'components/Send/SendConfirmationDialogMessage'
import SendFormMessage, {
  DEFAULT_FORM_INPUTS,
} from 'components/Send/SendFormMessage'
  ...
  return (
    <>
      <div className="item-center mx-auto flex max-w-4xl flex-col justify-center">
        <h1>Transfer Message across chains</h1>
        <p className="mt-8 text-center text-xl">
          Circle&apos;s Cross-Chain Transfer Protocol enables Message to be sent
